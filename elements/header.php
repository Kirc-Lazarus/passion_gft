    ...
    <header>
        ...
        <div class="en-tête">
            ...
            <div class="d-flex flex-row-reverse align-items-center">
                <!-- Si j'ai une clé 'auth' dans ma session (utilisateur connecté) -->
                <?php if (isset($_SESSION['auth'])) : ?>
                    <!-- Je fais apparître un bouton déconnexion et accés au profil -->
                    ...
                    <!-- Sinon -->
                <?php else : ?>
                    <!-- Je fais apparaître un bouton de connexion et d'inscription -->
        ...
        <div class="d-flex justify-content-center">
            ...
            <?php if (isset($_SESSION['auth'])) : ?>
                <!-- J'affiche le message bonjour suivi de son pseudo via la super variable session -->
